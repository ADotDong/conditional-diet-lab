...
def some_donuts(donuts_eaten,maximum_donut)
    if donuts_eaten < maximum_donut/2
        "Good job, Homer!"
    elsif donuts_eaten > maximum_donut
        "Get back on your diet!"
    end
end
...
def new_diet(donut_number,cookie_number)
    if donut_number == 0
        "Good job!"
    elsif cookie_number == 0
        "Good job!"
    elsif donut_number + cookie_number >= 2
        "Get back on your diet!"
    end
end
